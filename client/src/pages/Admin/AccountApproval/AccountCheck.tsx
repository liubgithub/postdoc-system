      ...
      <div style={{ height: '100%', padding: '20px' }}>
        <div style={{ background: "#fff", borderRadius: "12px", padding: "24px", boxShadow: '0 2px 12px rgba(0,0,0,0.1)' }}>
          <div style={{ marginBottom: '24px' }}>
            <h2 style={{ margin: '0 0 20px 0', color: '#333', fontSize: '24px', fontWeight: '600' }}>
              账号审批管理
            </h2>
          </div>
          ...
          <ElRow gutter={12} style={{ marginBottom: "24px" }}>
            <ElCol span={2}>
              <ElButton
                type="primary"
                style={{ width: "100px", height: 44, fontWeight: 500, fontSize: 16 }}
          ...
          <div style={{ marginTop: 24, width: "100%" }}>
            ...
            >
              ...
              <ElTableColumn
                ...
                v-slots={{
                  default: () => (
                    <ElButton type="primary" size="small" onClick={() => router.push('/admin/accountApproval')}>
                      查看
                    </ElButton>
                  ),
                }}
          ...
          <div style={{ width: "100%", display: "flex", justifyContent: "center", marginTop: "20px" }}>
            <ElButton style={{ width: 120 }} plain onClick={() => router.push('/admin/adminHome')}>
              返回
            </ElButton>
          </div>
        </div>
