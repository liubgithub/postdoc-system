                    ...
                    <div style={{ border: '1px solid #333', borderRadius: '4px', background: '#fff', padding: 0 }}>
                        ...
                        <div style={{ padding: '16px' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '8px' }}>
                                ...
                                <span style={{ marginLeft: '32px' }}>签名：<ElInput v-model={form.value.assessedSign} style={{ width: '120px', border: 'none', marginLeft: '8px' }} inputStyle={{ border: 'none', background: 'transparent' }} /></span>
                            </div>
                        </div>
                        {/* 主要工作区块 */}
                        ...
                        {/* 出勤情况区块 */}
                        <div style={{ borderTop: '1px solid #333', padding: '16px' }}>
                            <div style={{ fontWeight: 500, marginBottom: '4px' }}>出勤情况</div>
                        ...
                        <div style={{ borderTop: '1px solid #333', padding: '16px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '16px', marginTop: '8px' }}>
                                ...
                                <span>负责人签名<ElInput v-model={form.value.unitSign} style={{ width: '120px', border: 'none', marginLeft: '8px' }} inputStyle={{ border: 'none', background: 'transparent' }} /></span>
