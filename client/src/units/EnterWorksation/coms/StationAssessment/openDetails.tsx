import { ElInput, ElCheckboxGroup, ElCheckbox, ElButton } from 'element-plus'
        ...
        return () => (
            <div class={cls.formContainer}>
                <div class={cls.header}>
                    <h1>博士后进站考核意见表</h1>
                    <ElButton type="primary" onClick={() => props.onBack()}>返回</ElButton>
                </div>
                <div class={cls.formSection}>
                    <div class={cls.title}>合作导师意见 (如有挂名导师，挂名导师和实际导师均需签字)</div>
                ...
                <div class={cls.formSection}>
                    <div class={cls.title}>博士后工作秘书审核</div>
                    <div class={cls.content}>
                        <p class={cls.para}>同意招收，承诺已对申请人的思想政治、道德品质和学术性进行了考察，在资助期内提供不低于4万/年的工作津贴。</p>
                        <div class={cls.signature}>
                            <p>审核人签名：</p>
                ...
                <div class={cls.formSection}>
                    <div class={cls.title}>思想政治与道德品质、学术性考察意见 (由实际所在学院填写)</div>
                    <div class={cls.content}>
                ...
                <div class={cls.formSection}>
                    <div class={cls.title}>现场答辩考核组意见 (由实际所在学院填写)</div>
                    <div class={cls.content}>
                        <p>考核组成员名单：</p>
                ...
                <div class={cls.formSection}>
                    <div class={cls.title}>学院党政联席会意见 (由实际所在学院填写)</div>
                    <div class={cls.content}>
                        <div class={cls.signature}>
                            <p>院长签名：</p>
                            <p>党委盖章：</p>
                ...
                <div class={cls.formSection}>
                    <div class={cls.title}>人力资源部意见</div>
                    <div class={cls.content}>
                        <div class={cls.signature}>
                            <p>盖章：</p>
                            <p>年 月 日</p>
